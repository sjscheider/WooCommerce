...
/**
 * Class WC_Monetary_API_Reports_StoredValue_Groups_Transactions
 */
class WC_Monetary_API_Reports_StoredValue_Groups_Transactions extends WC_Monetary_API_Reports_Abstract
{
    /**
     * @var string
     */

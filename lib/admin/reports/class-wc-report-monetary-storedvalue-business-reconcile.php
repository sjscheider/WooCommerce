...
require_once(WC_MONETARY_PLUGIN_DIR . "/lib/api/reports/storedvalue/class-wc-monetary-api-reports-storedvalue-business-reconcile.php");

/**
 * Class WC_Report_Monetary_StoredValue_Business_Reconcile
 */
class WC_Report_Monetary_StoredValue_Business_Reconcile extends WC_Report_Monetary_Abstract
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $requestClass = 'WC_Monetary_API_Reports_StoredValue_Business_Reconcile';

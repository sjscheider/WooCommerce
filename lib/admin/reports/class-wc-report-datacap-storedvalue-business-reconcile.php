...
require_once(WC_DATACAP_PLUGIN_DIR . "/lib/api/reports/storedvalue/class-wc-datacap-api-reports-storedvalue-business-reconcile.php");

/**
 * Class WC_Report_Datacap_StoredValue_Business_Reconcile
 */
class WC_Report_Datacap_StoredValue_Business_Reconcile extends WC_Report_Datacap_Abstract
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $requestClass = 'WC_Datacap_API_Reports_StoredValue_Business_Reconcile';

...
require_once(WC_MONETARY_PLUGIN_DIR . "/lib/api/reports/storedvalue/class-wc-monetary-api-reports-storedvalue-groups-transactions.php");

/**
 * Class WC_Report_Monetary_StoredValue_Groups_Transactions
 */
class WC_Report_Monetary_StoredValue_Groups_Transactions extends WC_Report_Monetary_Abstract
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $requestClass = 'WC_Monetary_API_Reports_StoredValue_Groups_Transactions';
